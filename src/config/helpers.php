...
function icon_svg(string $name): string {
    $icons = [
        ...
        'plane'     => '<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M21 16v-2l-8-5V3.5C13 2.67 12.33 2 11.5 2S10 2.67 10 3.5V9l-8 5v2l8-2.5V19l-2.5 1.5V22l4-1 4 1v-1.5L13 19v-5.5l8 2.5z"/></svg>',
        'heart'     => '<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20.5s-7.5-4.6-9.5-9A5.5 5.5 0 0 1 12 6.3a5.5 5.5 0 0 1 9.5 5.2c-2 4.4-9.5 9-9.5 9z"/></svg>',
        ...
        'snow'      => '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v20M4.2 7l15.6 10M19.8 7L4.2 17"/><path d="M12 6l2-2M12 6l-2-2M12 18l2 2M12 18l-2 2"/></svg>',
        'fleet'     => '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 15l1.4-4.2A2 2 0 0 1 6.3 9.4h7.4a2 2 0 0 1 1.9 1.4L17 15v3.5h-2.5"/><path d="M3 15v3.5h2.5"/><circle cx="7" cy="18.5" r="1.5"/><circle cx="13" cy="18.5" r="1.5"/><path d="M8 6.5l1-2.1A2 2 0 0 1 10.8 3h7.4a2 2 0 0 1 1.9 1.4L21.5 8.5V12H19"/></svg>',
        'quote'     => '<svg viewBox="0 0 24 24" width="30" height="30" fill="currentColor"><path d="M9.5 6C6.5 6 4 8.6 4 11.8 4 14.9 6.2 17 9 17c.5 0 1-.1 1.4-.2-.6 1.6-2.1 2.9-4 3.4l.6 1.8c3.9-1 6.9-4.4 6.9-9.2C13.9 8.6 12 6 9.5 6zm10 0C16.5 6 14 8.6 14 11.8c0 3.1 2.2 5.2 5 5.2.5 0 1-.1 1.4-.2-.6 1.6-2.1 2.9-4 3.4l.6 1.8c3.9-1 6.9-4.4 6.9-9.2C23.9 8.6 22 6 19.5 6z"/></svg>',
        'facebook'  => '<svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor"><path d="M22 12a10 10 0 1 0-11.6 9.9v-7H7.9V12h2.5V9.8c0-2.5 1.5-3.9 3.8-3.9 1.1 0 2.2.2 2.2.2v2.5h-1.3c-1.2 0-1.6.8-1.6 1.6V12h2.8l-.4 2.9h-2.4v7A10 10 0 0 0 22 12z"/></svg>',
        ...
        'user'      => '<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="3.6"/><path d="M4.5 20c1.4-3.6 4.3-5.5 7.5-5.5s6.1 1.9 7.5 5.5"/></svg>',
        'note'      => '<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 3h9l4 4v14H6z"/><path d="M15 3v4h4M9 12h7M9 16h7M9 8.5h2.5"/></svg>',
        'close'     => '<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round"><path d="M6 6l12 12M18 6L6 18"/></svg>',
    ];
    return $icons[$name] ?? '';
}
