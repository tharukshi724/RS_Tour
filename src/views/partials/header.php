<nav class="navbar" id="navbar">
    <div class="navbar-inner">
        <a href="index.php" class="brand">
            <img class="brand-mark" src="<?= htmlspecialchars(public_asset_url('public/images/logo_new.png?v=' . ASSET_VERSION)) ?>" alt="<?= htmlspecialchars(SITE_NAME) ?> logo" width="46" height="26">
